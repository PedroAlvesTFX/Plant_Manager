...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('plantas.update', $planta->id  )); ?>" method="POST">
        ...
        <textarea id="especie" name="especie"><?php echo e(old('especie', $planta->especie)); ?></textarea><br>
...
<form action="<?php echo e(route('plantas.destroy',$planta->id)); ?>" method="POST" 
onsubmit="return confirm('Tem certeza que deseja deletar esta planta, <?php echo e($planta->nome_popular.'-'. $planta->id); ?> ?');">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/laravel_qr/resources/views/plantas/judit.blade.php ENDPATH**/ ?>