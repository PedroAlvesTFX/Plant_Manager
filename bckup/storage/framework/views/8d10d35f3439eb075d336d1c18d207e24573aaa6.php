...
<div class="container-fluid">
    ...
    <form action="<?php echo e(route('plantas.update', $planta->id)); ?>" method="POST">
        ...
        <input type="checkbox" id="e_panc" name="e_panc" <?php echo e($planta->e_panc ? 'checked' : ''); ?> >

        <label for="e_apicola">E Apicola:</label>
        <input type="checkbox" id="e_apicola" name="e_apicola" <?php echo e($planta->e_apicola ? 'checked' : ''); ?> >

        <label for="e_forrageira">E forrageira:</label>
        <input type="checkbox" id="e_forrageira" name="e_forrageira" <?php echo e($planta->e_forrageira ? 'checked' : ''); ?> >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel_qr/resources/views/planta/edit.blade.php ENDPATH**/ ?>