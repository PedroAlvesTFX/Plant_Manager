    ...
    <table class="table table-striped table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><em><?php echo e($planta->nome_cientifico); ?></em></td>
                <td>
                ...
                <td>
                    <div class="d-flex gap-2">
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('plantas.edit', $planta)); ?>" class="btn btn-sm btn-warning">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/laravel_qr/resources/views/plantas/index.blade.php ENDPATH**/ ?>